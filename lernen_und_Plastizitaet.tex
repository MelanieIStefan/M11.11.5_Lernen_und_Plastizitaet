...
% \begin{frame}
% \frametitle{Properties of LTP}

% \begin{block}{LTP is input-specific}
...
% \begin{itemize}
% \item
% LTP only happens at synapses where it has been induced. 
% \item
% It does not spread to other synapses.
% \end{itemize}
...
% %% Stages
% \begin{frame}
% \frametitle{Stages of LTP}

% \pause 

% \begin{block}{Early LTP}
% \begin{itemize}
% \item
% NMDAR activation leads to calcium influx
% \item
% Calcium activates CaMKII, which can then maintain stable activity
% \item
% CaMKII activates and increases the number of AMPA receptors
% \item
% Other signalling pathways are activated
% \item
% The actin cytoskeleton remodels to change spine shape and size
% \end{itemize}
% \end{block}

% \pause

% \begin{block}{Late LTP}
% \begin{itemize}
% \item
% More proteins are recruited through local synthesis
% \item
% Transcription factor signalling changes gene expression
% \item
