...
\item
Aktivierung von AMPAR führt zu Depolarisierung der Membran, wodurch die Mg\textsuperscript{2+} Blockade aufOgehoben wird.
\item
...
\begin{itemize}
\item
Was ist gemeint, wenn der NMDA Rezeptor als "Coincience detector" ("Gleichzeitigkeits-Detektor") bezeichnet wird?
\item
Wie höngt das mit der Hebbschen Lernregel zusammen?
\item
...
\item
Insgesamt verringert sich die Phosphorylierung von AMPA Rezeptoren, und die Synape wird langfristig geschwächt (Long Term Depression, LTD)
\end{itemize}
\end{block}
...
Bistabilität von Kinasen un Phosphatasen
...
\item
Aber CaMKII ist eine Kinase! D.h. sie kann sich selber phosporylieren! (Genauer: Eine Untereinheit im 6-er Ring phosphoryliert eine benachbarte Untereinheit) 
\item
...
\item
Lokale Proteinsynthese (aus zirkulierender mRNA) gewährleistet Spezifizität
\item
...
Woher weiß neu hergestelte mRNA (oder neu hergestelltes Protein), wo sie hin müssen?   \\ 
\pause "Synaptic tagging and cpature" - Molekulare Markierung, die zirkulierender mRNA anzeigt, dass hier eine Synapse ist.
